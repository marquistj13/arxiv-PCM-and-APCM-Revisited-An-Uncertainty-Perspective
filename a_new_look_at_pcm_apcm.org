...
4. The difference of the bandwidth correction between APCM and UPCM. APCM can directly scale the bandwidth, while UPCM can't. APCM can reduce the bandwidth while UPCM can't. UPCM accepts the estimated bandwidth and micro-adjust it through $\sigma_v$.
