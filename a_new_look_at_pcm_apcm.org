...
** The Unified Framework of PCM and APCM resulted from the Uncertainty Perspective
...
Based on this observation, we introduce the concept of /noise level/ $\alpha$ of the data set in the update equation of prototypes:
#+BEGIN_LaTeX
\begin{equation}
